 ...
 * segments occur once. Rendering the result after the fills keeps the selected
 * country outline complete at every zoom level.
 */
export function adminOuterBoundary(
  ...
  const coordinates = Array.from(segments.values())
